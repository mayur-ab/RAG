#!/usr/bin/env python
"""Verification script for ChromaDB integration."""
...
def test_chroma_basic_functionality():
    ...
    try:
        ...
        assert results[0][0].id == "chk1", f"Expected doc id 'chk1', got '{results[0][0].id}'"
        print("✓ Search by vector similarity works")
